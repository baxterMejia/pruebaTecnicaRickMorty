...
const ModalAddQuestions = ({
  ...
  const CreateSurveyHelperClass = new surveyHelper();
    ...
    switch (idTypeQuestionD) {
      ...
      case TypesQuestionsEnum.QuestionMultipleChoiceScale:
        dispatch(
          addQuestion({
            question:
              CreateSurveyHelperClass.questionMultipleChoiceScale(
                questionIsMandatory
              ),
            idQuestion,
          })
      ...
      case TypesQuestionsEnum.QuestionGraphicClassificationOfSmileys:
        dispatch(
          addQuestion({
            question:
              CreateSurveyHelperClass.questionGraphicClassificationOfSmileys(
                questionIsMandatory
              ),
            idQuestion,
          })
          ...
          <ul id="ul-wrapper-questions">
            ...
            <li
              ...
              onClick={() => {
                handleMouseEnter(
                  '/Pregunta9.jpg',
                  'Clasificación gráfica puntuación de caritas',
                  TypesQuestionsEnum.QuestionGraphicClassificationOfSmileys
                );
              }}
            >
              Clasificación gráfica puntuación de caritas
            ...
            <li
              id="li-question-multiple-choice-scale"
              className={
                idTypeQuestion ===
